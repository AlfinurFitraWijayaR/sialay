    ...
    <div className="max-w-4xl mx-auto space-y-4">
      ...
      <div className="bg-white rounded-lg border border-[#e2e8f0] p-6 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5">
          ...
          <div className="relative group shrink-0 mx-auto">
            ...
            <button
              ...
              className="absolute -bottom-1.5 -right-1.5 p-1.5 rounded-lg bg-white border border-[#cbd5e1] text-[#0f172a] shadow-xs hover:bg-[#FEF9C3] transition cursor-pointer disabled:opacity-50"
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            ...
            className="px-3.5 py-2 text-xs font-semibold text-[#0f172a] bg-[#FBC02D] hover:bg-[#E5A800] rounded-lg shadow-sm transition border border-[#FDE047] focus:outline-none focus:ring-2 focus:ring-[#FBC02D]"
          >
            Edit Data
          </Link>
          <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg border border-[#e2e8f0] p-6 shadow-sm space-y-4">
          <h2 className="text-xs font-bold uppercase tracking-wider text-[#0f172a] border-b border-[#e2e8f0] pb-2 flex items-center justify-between">
            <span>Profil Klub & Kelompok Usia</span>
            <span className="text-[10px] font-semibold bg-[#FEF9C3] text-[#78350F] px-2 py-0.5 rounded border border-[#FDE047] tabular-nums">
              {player.ku}
            </span>
          </h2>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#475569] mt-1 leading-relaxed">
                  Foto profil pemain akan dihapus secara permanen dari server
                  privat. Tampilan akan kembali menggunakan inisial nama pemain.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#475569] mt-1 leading-relaxed">
                  ...
                  beserta foto profilnya secara permanen dari server.
                </p>
              </div>
            </div>
